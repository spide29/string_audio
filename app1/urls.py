...
############################################################################ English Level
    ...
    path('ml1_answer_page', views.ml1_answer_page, name='ml1_answer_page'),
    ...
    path('ml2_answer_page', views.ml2_answer_page, name='ml2_answer_page'),
    ...
    path('ml3_answer_page', views.ml3_answer_page, name='ml3_answer_page'),
